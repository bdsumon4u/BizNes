...
class IconPicker extends Select
{
    ...
    public function setUp(): void
    {
        ...
        $this
            ->itemTemplate(fn (IconPicker $component, string $icon) => view('filament.icon-picker-item', [
                'icon' => $icon,
            ])->render())
            ->placeholder(__('forms.placeholder.icon_placeholder'));
    }
