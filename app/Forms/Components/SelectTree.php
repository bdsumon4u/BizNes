...
class SelectTree extends Field implements HasAffixActions
{
    ...
    protected string $view = 'forms.components.select-tree';
    ...
    public function relationship(?string $name = null, ?string $titleAttribute = 'name', string $parentAttribute = 'parent_id', ?Closure $modifyQueryUsing = null): self
    {
